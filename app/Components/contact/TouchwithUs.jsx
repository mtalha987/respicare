...
const TouchWithUs = () => {
  return (
    <>
      <div className="xl:px-[90px] lg:px-[40px] px-5 flex mt-20 xs:mt-10 bg-white lg:justify-between flex-wrap justify-center  ">
        <div className="py-20 xs:py-5 lg:pl-14 xs:pl-3 pl-5 shadow-lg lg:w-6/12">
        ...
        <div className="lg:w-6/12 flex justify-end mt-12 lg:mt-0 h-[400px] lg:h-auto w-full ">
        <iframe
