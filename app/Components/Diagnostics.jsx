...
const Diagnostics = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row 2xl:justify-center xs:mt-20 xs:items-center">
        <div className="ml-16 2xl:ml-0 xs:order-1 xs:ml-0">
          <Image src={DiagnosticsProfile} alt="Diagnostics" className="" />
        </div>
        <div className="lg:mt-44 mx-10 2xl:mx-0 xs:mx-5 ">
